...
class Sync_voting extends CI_Controller {	
	...
	{		
		...
		if($this->it_model->updateData( "voting" , $edit_data, "client_sn ='".$sn."' and comm_id = '".$comm_id."'"))
		{					
			echo '1';						
		}
		else 
	...
	{		
		...
		if($this->it_model->updateData( "voting_option" , $edit_data, "client_sn ='".$sn."' and comm_id = '".$comm_id."'"))
		{					
			echo '1';						
		}
		else 
