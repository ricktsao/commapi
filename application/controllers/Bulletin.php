 ...
 */
class Bulletin extends REST_Controller {
	...
	public function index_get()
    {
		...
		else 
		{
			...
			$news_list = $this->c_model->GetList( "bulletin" , $condition ,TRUE, NULL , NULL , array("sort"=>"asc","start_date"=>"desc","sn"=>"desc") );
			if ($news_list['count'] > 0) 
			{
				...
				foreach ($news_list["data"] as $news_info) 
				{
					...
					{
						$img_url = $this->config->item("api_server_url")."upload/".$comm_id."/bulletin/".$news_info["img_filename"];
					}	
